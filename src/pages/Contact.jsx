    ...
    return(
        ...
        <button onClick={goToHome} className="p-2 absolute top-[600px] md:top-0 md:right-0"><svg fill="#000000" width="64px" height="34px" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M16 0c-8.836 0-16 7.163-16 16s7.163 16 16 16c8.837 0 16-7.163 16-16s-7.163-16-16-16zM16 30.032c-7.72 0-14-6.312-14-14.032s6.28-14 14-14 14 6.28 14 14-6.28 14.032-14 14.032zM21.657 10.344c-0.39-0.39-1.023-0.39-1.414 0l-4.242 4.242-4.242-4.242c-0.39-0.39-1.024-0.39-1.415 0s-0.39 1.024 0 1.414l4.242 4.242-4.242 4.242c-0.39 0.39-0.39 1.024 0 1.414s1.024 0.39 1.415 0l4.242-4.242 4.242 4.242c0.39 0.39 1.023 0.39 1.414 0s0.39-1.024 0-1.414l-4.242-4.242 4.242-4.242c0.391-0.391 0.391-1.024 0-1.414z"></path> </g></svg><p className="text-[#000]">Go home</p></button>
            <div className=" w-[90vw] sm:w-[50vw] lg:w-[35vw] h-[80vh] bg-[#000] flex flex-col items-center justify-evenly ">
                ...
                <h3 className="font-semibold tracking-[5px] ">The steps are simple</h3>
                    <ul className="steps">
            ...
            <form action="" className="w-full p-4 md:p-0 md:w-[30vw] h-[50%] justify-evenly flex flex-col items-center bg-[#000] " >
                ...
                <button className="btn btn-outline mt-4 hover:bg-white">Send</button>
